...
function renderizarUsuarios(personas) {
    ...
    for (var i = 0; i < personas.length; i++) {
        ...
        html += '   <a data-id="' + personas[i].id +
            '" href="javascript:void(0)"><img src="assets/images/users/1.jpg" alt="user-img" class="img-circle"> <span>' + personas[i].nombre + '<small class="text-success">online</small></span></a>';
        html += '</li>';
    }
...
formEnviar.on('submit', function (e) {
    ...
    if (e.preventDefault(txtMensaje.val().trim().length === 0)) {
        return;
    }
